            ...
            <div className="w-full ml-auto mb-[3.125rem]  pl-0 lg:px-0 lg:pl-[7.1875rem]">
              <div className="mt-4 pb-4 px-4 lg:px-0 border-black">
                ...
                <p className="text-base pr-0 lg:pr-2 mt-4">
                  ...
                  dolorum nam, sit inventore. Laudantium voluptates sit non
                  autem? Dolorum, error hic animi laboriosam in iure. Officia
                  harum recusandae vel possimus id, animi consequatur, veritatis
                  autem ex labore corrupti velit alias consectetur fuga
                  inventore quasi!
                </p>
              </div>
            </div>
